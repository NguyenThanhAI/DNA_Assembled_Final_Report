...
\begin{document}
    ...
    %\subsection{Thủ tục chương trình chính}
    ...
    %\subsection{Thuật toán khởi tạo đồ thị de Bruijn}
    ...
    %\subsection{Thuật toán kiểm tra hai cạnh cùng bội có thể merge được không}
    ...
    %\subsection{Thuật toán kiểm tra hai cạnh khác bội có thể merge được không}
    ...
    %\subsection{Thuật toán kiểm tra đồ thị Euler}
    ...
    %\subsection{Thuật toán tìm đường đi Euler}
    ...
    %\subsection{Thuật toán xác định các đoạn chồng lấn}
    ...
    %\subsection{Thuật toán xác định bội cạnh}
    ...
    %\subsection{Thuật toán kiểm tra hai cạnh có phải là liền kề trong một Read hay không}
    ...
    %\subsection{Thuật toán cập nhật vị trí các cạnh trong một Read khi x và y là liền kề}
    ...
    %\subsection{Thuật toán xác định chênh lệch bậc ra và bậc vào của một đỉnh}
    ...
    %\subsection{Thuật toán cập nhật vị trí các cạnh trong một Read khi x là cạnh kết thúc Read}
    ...
    %\subsection{Thuật toán cập nhật vị trí các cạnh trong một Read khi y là cạnh bắt đầu Read}
    ...
    %\subsection{Thuật toán merge các cạnh cùng bội số}
    ...
    %\subsection{Thuật toán merge các cạnh khác bội số}
    ...
    %\subsection{Thuật toán xóa các đỉnh và cạnh sau khi merge các cạnh}
